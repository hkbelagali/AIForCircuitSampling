"""Push L=6 until the VMC-steps curve hits the eval-every=10 floor (10 steps),
mirroring L=3, L=4, L=5. Pattern so far: floor reached at ~40 x D_sector.
L=6 sector dim is 400, so predicted floor crossing is around k = 16000.
...
L = 6
EXTRA_KS = [500, 1000, 2000, 3000, 4000, 6000, 8000, 10000, 12500, 16000, 20000]
SEEDS = list(range(8))
N_WORKERS = 96
